      ...
      <div className="mt-6 rounded-2xl border border-brand-gray-light bg-white p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-brand-gray">Tell us what you lost and where.</p>
          </div>
        </div>
        ...
        {!result ? (
          <form onSubmit={onSubmit} autoComplete="off" className="mt-8 space-y-5">
            ...
            <div>
              <label className="mb-1.5 block text-sm font-medium text-dark-2">
                Date lost <span className="font-normal text-brand-gray">(optional)</span>
              </label>
              <input
                className={inputClass}
                type="date"
            ...
            >
              {loading ? "Publishing…" : "Report Lost Item"}
            </button>
          </form>
        ) : (
          <div className="mt-8 space-y-8">
            ...
            <MatchSuggestions
              ...
              heading="Similar found items (best match first)"
              subheading="We searched found listings for possible matches."
            />
